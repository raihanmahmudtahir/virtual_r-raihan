    ...
    <div className="flex flex-col items-center mt-6 lg:20">
       <h1 className="text-4xl sm:text-6xl lg:text-7xl text-center tracking-wide">
        ...
        <p className="mt-10 text-lg text-center text-neutral-500 max-w-4xl">
            Empower your creativity and bring your VP app ideas to life with our intuitive development tools. Get started today and turn your imagination into immersive reality!
        </p>
